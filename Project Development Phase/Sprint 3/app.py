...
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=6667d8e9-9d4d-4ccb-ba32-21da3bb5aafc.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=30376;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=lgj37908;PWD=4NNaAagWKZae42zD",'','')
...
def out():
    if request.method == "POST":
        nutrients = {}
        USDAapiKey = 'flYmBbhNL4RXqkJ7M80adL5dNKvn3THtM0eQ48Er'
